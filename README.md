...
The image taken will be renamed as desired, the image taken to be renamed is in the recognition folder named image.jpg.
5. In the config.yaml section "known_people" we put the name of the person, the reference file and the topic, where we will publish a MQTT message.
